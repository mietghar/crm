...
return [
	...
	*/
	...
	"date"                 => "pole :attribute nie jest prawidłowe",
	"date_format"          => "The :attribute does not match the format :format.",
	"different"            => "The :attribute and :other must be different.",
	"digits"               => "The :attribute must be :digits digits.",
	"digits_between"       => "pole :attribute musi mieć pomiędzy :min i :max cyfr.",
	"email"                => "pole :attribute nieprawidłowe.",
	...
	"max"                  => [
		"numeric" => "pole :attribute nie może być dłuższe niż :max.",
	...
	*/
	...
	//'attributes' => [],
        'attributes' => array(
            ...
            'price' => 'cena',
            'postal' => 'kod pocztowy',
            'email_desc' => 'opis adresu e-mail',
            'nip' => 'NIP',
            'phone' => 'telefon',
            'phone_desc' => 'opis telefonu',
            'city' => 'miasto',
            'street' => 'ulica',
            'surname' => 'nazwisko',
            'time' => 'godzina',
